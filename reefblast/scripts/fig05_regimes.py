...
The charge is directly above the plate, so range means vertical standoff
and the shock arrives at normal incidence.
(a) Largest tensile stress in a 12 cm plate within the integration window
(10 decay constants after first arrival) over its tensile strength,
against standoff and void fraction, from the batched
...
(b) Spall standoff, the largest standoff at which sigma_T >= 2 MPa, against
void fraction for four plate thicknesses, and the compressive (crush)
standoff of the 12 cm plate (dashed).  The shaded band lies inside the
...
ax.set_xlabel(r"vertical standoff $R$ (m)")
